            ...
            <div className="space-y-12">
                ...
                <section id="third-party">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                        We partner with select service providers to deliver our AI
                        capabilities and manage payments:
                    </p>
                ...
                <section id="user-rights">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-4 rounded-lg bg-[#f1f0f5] dark:bg-white/5">
