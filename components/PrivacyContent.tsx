        ...
        {[
          {
            ...
            content: (
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                This Privacy Policy outlines how Clipboard collects, processes,
                encrypts, and protects your saved clipboard history and account data.
              </p>
            ),
          },
          {
              ...
              <>
                ...
                <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>Encrypted Clipboard Items (text, URLs, images, files, and templates)</span>
                  </li>
                </ul>
                <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed italic font-bold">
                  We DO NOT and CANNOT access the raw, unencrypted contents of your saved clipboard items.
                </p>
              </>
            ),
          },
              ...
              <>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    "Authenticate via Firebase / Google",
                    "Sync Clipboard History across Android and iOS devices",
                    "Enable quick search and categorization",
                    "Manage subscriptions",
                    "Provide secure cloud synchronization",
                  ].map((item, i) => (
                    <div
                      key={i}
          ...
          },
          {
            ...
            content: (
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Data is processed based on user consent, service necessity, and
                our legitimate interests in providing secure clipboard history
                management.
              </p>
            ),
          },
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#6b608a] dark:text-[#a097bd]">
                        Secure Authentication and cross-platform cloud data syncing for Android and iOS
                      </p>
                    </div>
                  </div>
                </div>
                <p className="mt-4 text-xs text-[#6b608a] dark:text-[#a097bd] italic">
                  These third-party systems only store ciphertext. They do not hold encryption keys to read or decrypt your clipboard data.
                </p>
              </div>
            ),
          },
          {
            ...
            content: (
              <div className="space-y-4">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Clipboard encrypts your saved clipboard data (including text, URLs, images, and files) locally on your device before syncing it to our secure servers. Only your authenticated account has the keys required to decrypt this data. You are solely responsible for ensuring your local devices remain secure from physical or digital intrusion.
                </p>
              </div>
            ),
          },
          {
            ...
            content: (
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Encrypted clipboard history is retained as long as your account is active. Users can clear their clipboard history or permanently delete individual items at any time.
              </p>
            ),
          },
          {
            ...
            content: (
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Data may be processed by cloud services located in other
                jurisdictions, governed by secure transmission and data protection standards.
              </p>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                <div className="space-y-3">
                  {[
                    "Access to non-sensitive account profile data",
                    "Correction of account details",
                    "Complete deletion of Remote Clipboard Sync Data",
          ...
          },
          {
            ...
            content: (
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                The platform may use essential session mechanisms necessary for account authentication, subscription management, and secure cross-device sync.
              </p>
            ),
          },
          {
