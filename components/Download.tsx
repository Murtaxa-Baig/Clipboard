  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Download Clipboard App
        </motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {[
            { icon: "apple", label: "Download on the", store: "App Store (iOS)", href: "https://apps.apple.com/us/app/paste-limitless-clipboard/id967805235" },
            { icon: "play", label: "Get it on", store: "Google Play (Android)", href: "https://play.google.com/store" },
          ].map((card, index) => (
            <motion.a
              key={index}
              href={card.href}
